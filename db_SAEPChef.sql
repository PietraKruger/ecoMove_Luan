...
imagem_usuario varchar(100) not null,
tipo tipo not null,
...
favoritar varchar(100) not null,
created_at timestamp without time zone not null,
updated_at timestamp without time zone not null,
id_usuario int references tb_usuario(id_usuario),
id_receita int references tb_receita(id_receita)
);
...
INSERT INTO tb_receita(
	id_receita, titulo_receita, origem_receita, url_imagem, created_at, updated_at, id_usuario)
	VALUES 
	(1, 'Bolo de Cenoura Fofinho', 'Chef Marco Bianchi', 'imagem1.jpg', '2026-01-10 09:15:00', '2026-01-10 09:15:00', 1),
	(2, 'Pudim de Leite Condensado', 'Chef Ana Ferreira', 'imagem2.jpg', '2026-01-12 10:30:00','2026-01-12 10:30:00', 2),
	(3, 'Risoto Cremoso de Camarão', 'Chef Lucas Tanaka', 'imagem3.jpg', '2026-01-14 14:20:00', '2026-01-14 14:20:00', 3);
